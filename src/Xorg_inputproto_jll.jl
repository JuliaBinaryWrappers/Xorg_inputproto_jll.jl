...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Xorg_inputproto_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("84d6cd60-beca-5f49-93c5-789031781a2d"))
...
if best_platform === nothing
    @debug("Unable to load Xorg_inputproto; unsupported platform $(triplet(platform_key_abi()))")
else
